...
import com.lojaInformatica.lojaInformatica.Repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> GetByPreco(){
		return ResponseEntity.ok(repository.findByPreco());
	}
